...
import view.ICritterUpdate;

/**
 * Describes an Owner. An owner owns an ICritter and has money to buy Treats for
 * his/her/it's ICritter
 * 
 * @author John McGowan
 */
public class Owner extends Observable {
	 ...
	 * <b>Owner</b>
	 * <p>
	 * Constructs a new Owner. During construction, the owner will create an
	 * ICritter to own as well.
	 * 
	 * @param oName
	 *            The name of the Owner
	 * @param cName
	 *            The name of the Owner's ICritter
	 * @author John McGowan
	 */
	 ...
	 * <b>giveTreat</b>
	 * <p>
	 * Gives a treat to this owner's ICritter and returns the ICritter's
	 * reaction. If the owner does not own the treat, this method will return
	 * null. Once finished, this owner will no longer own the treat passed in.
	 * 
	 * @param theTreat
	...
	public ICritterReaction giveTreat(Treat theTreat) {
		if (treats.contains(theTreat)) {// does the owner own the treat?
			...
			return iCritter.receiveTreat(theTreat);// return the ICritter's
													// reaction
		} else
	 ...
	 * <b>buyCheapTreat</b>
	 * <p>
	 * Buys a cheap treat with the given description and adds it to the owner's
	 * treats list. If the Owner does not have enough credits, the treat will
	 * not be bought and the treat will not be added, this method will also
	 * return null. If the Owner does have enough credits, the treat will be
	 * bought and the treat returned.
	 * 
	 * @param desc
	 ...
	 * <b>buyFancyTreat</b>
	 * <p>
	 * Buys a fancy treat with the given description and adds it to the owner's
	 * treats list. If the Owner does not have enough credits, the treat will
	 * not be bought and the treat will not be added, this method will also
	 * return null. If the Owner does have enough credits, the treat will be
	 * bought and the treat returned.
	 ...
	 * <b>listTreats</b>
	 * <p>
	 * This will return a list of treats owned by the owner. This list may be
	 * empty.
	 * 
